...
- The most recent patch version of Craft Store.
- Any version of Craft Store that's included in a current release of a Canonical
  product.
...
[Private Security Report]: https://github.com/canonical/craft-store/security/advisories/new
